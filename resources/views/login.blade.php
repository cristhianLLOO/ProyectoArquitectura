...
<div class="box">
    <form class="form_container" action="{{ route('usuarioLogin') }}" method="post">
        @csrf
        <div class="form">
        ...
        <div class="cont_btn">
            <input type="submit" class="sign-in_btn" value="Iniciar Sesión">
        </div>

        <h6 class="title3">No tienes cuenta?</h6>

        <div class="cont_btn">
            <a href="/register"><input type="button" class="sign-in_btn" value="Registrate"></a>
        </div>
